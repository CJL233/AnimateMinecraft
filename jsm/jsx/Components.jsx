...
function Output({states:{_Materials, _Types, _Objects, _info, _image}, tip}){
	function Click(){
		...
		const htmlText=['<!DOCTYPE html>',
			...
			<body>
			  <a title="View on Github" href="https://github.com/CJL233/AnimateMinecraft/tree/main/examples"><svg style="margin: 0.5rem;position: absolute;right: 0;" height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github v-align-middle">
